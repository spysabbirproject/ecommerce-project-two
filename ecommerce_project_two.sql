...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2023 at 12:23 PM
...
CREATE TABLE `admins` (
  ...
  `profile_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_profile_photo.png',
...
INSERT INTO `admins` (`id`, `name`, `email`, `phone_number`, `gender`, `address`, `profile_photo`, `status`, `email_verified_at`, `password`, `role`, `warehouse_id`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Sabbir Ahammed', 'superadmin@gmail.com', NULL, NULL, NULL, 'default_profile_photo.png', 'Yes', NULL, '$2y$10$3kuxx4TS2otI3mLCoR4M0ePQdrbvNO89ncBVP3gL/ge.qHwQR5.zq', 'Super Admin', NULL, '2V78Rr4b7jjdyxKUpLFaOJtMzWdnykiiPiTp5DSbUXpThs2F43gcuWLayovB', '2023-02-17 22:56:21', '2023-02-17 22:56:21'),
(2, 'Sabbir Ahammed', 'admin@gmail.com', NULL, NULL, NULL, 'default_profile_photo.png', 'Yes', NULL, '$2y$10$hxBLW/E2prT2QLkIlV1ot.8ge5bkyDi9z/e4UPqezAxP2Pg9HioLC', 'Admin', NULL, NULL, '2023-02-17 22:57:51', '2023-02-17 22:57:51'),
(3, 'Sabbir Ahammed', 'dhakawarehouse@gmail.com', NULL, NULL, NULL, 'default_profile_photo.png', 'Yes', NULL, '$2y$10$CpF8N5qbOwT2fTE.Pa6WreCJFSylne/w.zEqNmKDA6UdqsBxpdXQC', 'Warehouse', NULL, 'I1MyhHa7wKZK1bNJPbWTiNnEjdAsvMz66YBI61Xm7C6ug7zzII6QrhmKMmsx', '2023-02-17 22:58:28', '2023-02-17 22:58:28');
...
CREATE TABLE `banners` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `banner_position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `blogs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `blog_headline` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `blog_slug` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `blog_category_id` int(11) NOT NULL,
  `blog_quota` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `blog_thumbnail_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_blog_thumbnail_photo.jpg',
  `blog_cover_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_blog_cover_photo.jpg',
...
CREATE TABLE `blog_categories` (
  ...
  `top_blog_category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `brands` (
  ...
  `top_brand` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `categories` (
  ...
  `show_home_screen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `childcategories` (
  ...
  `childcategory_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `coupons` (
  ...
  `coupon_offer_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `default_settings` (
  ...
  `logo_photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `address` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_map_link` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `faqs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `faq_position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `features` (
  ...
  `feature_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `flashsales` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `flashsale_offer_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `flashsale_offer_slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `flashsale_offer_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `flashsale_offer_banner_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `newsletters` (
  ...
  `newsletter_body` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_returns` (
  ...
  `return_reason_details` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `return_reason_photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order_summeries` (
  ...
  `customer_order_notes` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `flashsale_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  `flashsale_id` int(11) DEFAULT NULL,
  `today_deal_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
...
CREATE TABLE `product_featured_photos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `product_id` int(11) NOT NULL,
  `product_featured_photos` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `social_login_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `google_auth_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  ...
  `facebook_auth_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
...
CREATE TABLE `subcategories` (
  ...
  `subcategory_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `teams` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `team_member_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `team_member_designation` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `team_member_photo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_profile_photo.png',
  `team_member_facebook_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `team_member_twitter_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `team_member_instagram_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `team_member_linkedin_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Yes',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
...
CREATE TABLE `warehouses` (
  ...
  `warehouse_email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
