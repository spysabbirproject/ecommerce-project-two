                                ...
                                <div class="carousel-item active">
                                    <div class="p-10">
                                        ...
                                        <small><i class="fa fa-level-up text-success"></i><br>
                                            Total Customer</small>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="p-10">
                                        <h2 class="font700 float-left mr-2">
                                            {{ $users->where('created_at', '>', Carbon\Carbon::now()->subDays(7))->count() }}
                                        </h2>
                                        <small><i class="fa fa-level-up text-success"></i><br>
                                            New Customer </small>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-3">
                        <div id="Summary2" class="carousel vert slide" data-ride="carousel" data-interval="1200">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="p-10">
                                        <h2 class="font700 float-left mr-2">{{ $visitors->count() }}</h2>
                                        <small><i class="fa fa-level-down text-danger"></i><br>
                                            All Visiter</small>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="p-10">
                                        <h2 class="font700 float-left mr-2">
                                            {{ $visitors->where('visit_time', '>', Carbon\Carbon::now()->subDays(7))->count() }}
                                        </h2>
                                        <small><i class="fa fa-level-up text-success"></i><br>
                                            New Visiter</small>
                                    </div>
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <div class="col-4 text-right">
                        <h2 class="m-b-0">{{ $subscribers->count() }}</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="body">
                <div class="row clearfix">
                    ...
                    <div class="col-4 text-right">
                        <h2 class="m-b-0">{{ $contact_messages->count() }}</h2>
                    </div>
                </div>
            </div>
        </div>
