    ...
    $(document).ready(function() {
        ...
        $('.print').on('click', function(e){
            ...
            $.ajax({
                ...
                method: 'GET',
                data: { payment_method : $('#payment_method').val(), payment_status : $('#payment_status').val(), order_status : $('#order_status').val(), created_at_start : $('#created_at_start').val(), created_at_end : $('#created_at_end').val() },
